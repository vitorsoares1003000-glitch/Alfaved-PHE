// ============================================================
// AlfaVed PHE v48 — CORRELAÇÕES DE TRANSFERÊNCIA DE CALOR
// FIX v48: thetaFilter SEM heurística (todas as placas testadas)
//          wallShear usa comprimento por passagem (não total)
//          condensação com piso realista (2000 W/m²K)
// ============================================================
...
// ---------- FILTRO DE ÂNGULO (theta) — FIX v48 ----------
// FIX: REMOVIDA heurística que excluía placas. Todas as placas
// são testadas pelo otimizador (que escolhe a melhor por dP/área).
...
function calcVaporFlow(Qkw, p){
  ...
  var mV = safeDiv(Qkw, hfg, 0);
  var vCond = safeDiv(mV, 943, 0) * 3600;
...
function cL(a, b, c, d){
  ...
  if (Math.abs(d1 - d2) < 0.01) return Math.abs(d1);
